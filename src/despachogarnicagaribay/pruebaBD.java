...
public class pruebaBD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prueba Conexión");

        jButton1.setText("Pruébame");
        ...
        resultado.setText("DESCONECTADO");

        jLabel3.setText("PruebaLllenar Tabla");

        jButton2.setText("LLena");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cdb.conectar();
        if("conectado".equals(cdb.estado)){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        cdb.conectar();
        try {
            jTable1.setModel(cdb.tablaPrueba());
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,ex);
            Logger.getLogger(pruebaBD.class.getName()).log(Level.SEVERE, null, ex);
        }
